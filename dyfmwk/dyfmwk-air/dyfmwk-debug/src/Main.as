...
import com.github.rozd.bugs.dyfmwk.DYFMWK;
...
public class Main extends Sprite {
    public function Main() {
        ...
        new PlainButton(this, { y: 0, w: 280, label: "IsSupported"}, function (): void {
            trace(DYFMWK.isSupported);
        });

        new PlainButton(this, { y: 50, w: 280, label: "ANE version"}, function (): void {
            trace(DYFMWK.extensionVersion());
        });
